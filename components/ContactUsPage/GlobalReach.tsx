  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-10">
        ...
        <div className="flex justify-center">
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3 sm:gap-4 lg:gap-5 xl:gap-6 max-w-fit">
            {exportCountries.map((country, index) => (
              <div
                key={index}
                className="w-[100px] h-[96px] sm:w-[110px] sm:h-[106px] md:w-[120px] md:h-[116px] lg:w-[130px] lg:h-[126px] bg-white rounded-[5px] flex flex-col items-center justify-center cursor-pointer group"
                style={{
